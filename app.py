...
from study_buddy.dashboard import settings
from study_buddy.dashboard.constants import BASE_DIR
from study_buddy.dashboard.models import Admin
from study_buddy.dashboard.providers import LoginProvider
